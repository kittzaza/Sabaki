module.exports = {
  ...
  "menu.edit": {
    ...
    "Toggle Good Move": "Toggle Good Move",
    "Toggle Bad Move": "Toggle Bad Move",
    "Annotate": "&Annotate",
  ...
  "menu.navigation": {
    ...
    "Decrement Downstream Variation": "&Decrement Downstream Variation",
    "Increment Downstream Variation": "&Increment Downstream Variation",
  ...
  "menu.view": {
    ...
    "From Game Start": "From Game Start",
    "From Variation Start": "From Variation Start",
    ...
    "Show Analysis Graph": "Show &Analysis Graph",
  ...
  "sabaki.coach": {
    "Turn on analysis with a coach engine before reviewing a game.": "Turn on analysis with a coach engine before reviewing a game."
  },
  "sabaki.node": {
  ...
  "PreferencesDrawer": {
    ...
    "Always show game result": "Always show game result",
    ...
    "Remove": "Remove",
    "(Unnamed Engine)": "(Unnamed Engine)",
    "Path (e.g., /path/to/engine or C:\\path\\to\\engine.exe)": "Path (e.g., /path/to/engine or C:\\path\\to\\engine.exe)",
    "Optional arguments (e.g., -param1 value1 -param2 value2)": "Optional arguments (e.g., -param1 value1 -param2 value2)",
